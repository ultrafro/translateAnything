...
Double-click **Start Captions.bat**. The transcript is the main window. Click **⚙** to open settings inside it, select your audio output and caption languages, then click **Start live captions** when **Ready** appears. Start/Stop stays at the bottom of both views. To caption your own voice too, check **Include my microphone** and select your microphone before starting. **Preview** shows the overlay without capturing audio.
